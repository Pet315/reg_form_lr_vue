...
<!--        </a>-->
<!--        <a href="https://twitter.com/intent/tweet?text={{urlencode($request['tw']['text'])}}&url={{urlencode($request['tw']['link'])}}" class="btn btn-link" id="tw_link" target="_blank">-->
...
<!--            <h4>All members ({{ $request['number'] }})</h4>-->
<!--        </a>-->
<!--    </div>-->
</template>
